...
public class Main extends org.bukkit.plugin.java.JavaPlugin {
  ...
  public void registerConfig() {
    ...
    this.settings.put( "z_protected_areas",  this.getConfig().getStringList( "z_protected_areas" )  );
    this.settings.put( "z_protected_chests", this.getConfig().getStringList( "z_protected_chests" ) );
  }
  ...
  public java.util.Map< java.lang.String, java.lang.String > protectedAreas = new java.util.HashMap< java.lang.String, java.lang.String >();
  public java.util.Map< java.lang.String, java.lang.String > protectedChests = new java.util.HashMap< java.lang.String, java.lang.String >();
  public void registerProtectedAreas() {
    // PlayerName: AreaName: X,Y,Z,DX,DY,DZ
    java.util.List< java.lang.String > players = this.getConfig().getStringList( "z_protected_areas" );
